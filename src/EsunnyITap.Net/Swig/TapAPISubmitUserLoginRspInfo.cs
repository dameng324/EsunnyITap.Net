...
public class TapAPISubmitUserLoginRspInfo : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          EsunnyITapApiPINVOKE.delete_TapAPISubmitUserLoginRspInfo(swigCPtr);
        }
  ...
  public string UserNo {
    set {
      EsunnyITapApiPINVOKE.TapAPISubmitUserLoginRspInfo_UserNo_set(swigCPtr, value);
    } 
    get {
      string ret = EsunnyITapApiPINVOKE.TapAPISubmitUserLoginRspInfo_UserNo_get(swigCPtr);
      return ret;
    } 
  }

  public TapAPISubmitUserLoginRspInfo() : this(EsunnyITapApiPINVOKE.new_TapAPISubmitUserLoginRspInfo__SWIG_0(), true) {
  }

  public TapAPISubmitUserLoginRspInfo(TapAPISubmitUserLoginRspInfo other) : this(EsunnyITapApiPINVOKE.new_TapAPISubmitUserLoginRspInfo__SWIG_1(TapAPISubmitUserLoginRspInfo.getCPtr(other)), true) {
